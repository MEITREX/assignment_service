...
public interface CodeAssessmentProvider {
    ExternalCourse getExternalCourse(String courseTitle, LoggedInUser currentUser) throws ExternalPlatformConnectionException, UserServiceConnectionException;
    ...
    ExternalGrading syncGradeForStudent(String repoLink, LoggedInUser currentUser) throws ExternalPlatformConnectionException, UserServiceConnectionException;
